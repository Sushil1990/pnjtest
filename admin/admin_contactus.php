...
<div class="admininfo">
	    <div class="adminpagename" style="text-align:center; font-family:'Times New Roman', Times, serif; font-size:20px; color:#FFFFFF;  ">
			<strong>Admin Contact Us</strong>
</div>
...
<?php
		...
		if(isset($_POST['submit']))
		{
				include("dbcon.php");
				 $text=$_POST['text'];
				 //echo "$text";
				 $update=mysql_query("update main_table set contact='$text' where email='$email'");
				 if($update)
				 {
...
<div style="width:850px; float:center; margin-left:10px; margin-top:10px; border-radius:10px;">
	...
	<textarea name="text" style="width:770px; height:auto;" cols='50' rows='20'><?php echo $data['contact']; ?>
